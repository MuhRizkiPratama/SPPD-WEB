...
?>
    <main>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#updateModal <?= $no ?>"><i class="bi bi-pencil-square"></i></button>
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal <?= $no ?>"><i class="bi bi-trash"></i></button>
                                    </td>
                                </tr>
                                <?php
                                    };
        ...
        <div class="modal fade" id="updateModal <?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form action="../../backend/jabatan/update.php" method="post">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="update_jabatan" class="btn btn-primary">Tambah</button>
                        </div>
                    </div>
                </form>
            </div>
