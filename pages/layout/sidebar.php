...
?>
    <aside class="shadow">
            ...
            <div class="d-flex align-items-start justify-content-center flex-column ms-2 mt-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item fw-semibold" href="../surat/riwayat.php">Histori Pengajuan</a></li>
                    </ul>
                </div>
        ...
        <div class="d-flex justify-content-start align-items-center ms-3">
            <div class="logout">
                <a class="btn fw-semibold" href="../../backend/autentifikasi/logout.php">Log Out</a>
            </div>
        </div>
    </aside>